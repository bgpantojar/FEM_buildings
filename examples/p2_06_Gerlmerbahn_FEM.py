...
path_builder_script = "../examples/p2_06_Gerlmerbahn_LOD3.py" #Path to file to call freecad builder
ctes=[.05, .4, .1, .3, .2] #ctes[0,1,2,3] -> opening regularization. ctes[4] = cte_fil4 -> filtering small detected openings
