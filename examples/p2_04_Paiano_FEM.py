...
#p2_04 
data_folder = 'p2_04_Paiano' 
im1 = ('DJI_0347','DJI_0355_c','DJI_0365', 'DJI_0376')
how2get_kp = 1 #0: detecting openings with CNN; 1:reading npy files with opening coordinates
path_builder_script = "../examples/p2_04_Paiano_LOD3.py" #Path to file to call freecad builder
ctes=[.05, .3, .1, .3, .2] #ctes[0,1,2,3] -> opening regularization. ctes[4] = cte_fil4 -> filtering small detected openings
